...
![[assets/lkb-j-3/title.png]]

## 欲求：
（1）若$sinC = \frac{4}{5}$，$DE=5$，$AD$的长
（2）证明$2DE^2=CD*OE$
...
> $\therefore \angle BOE = \angle ODA = \angle DOE$。
> 又$\because OB=OD, OE=OE$，
> $\therefore \triangle DOE \cong \triangle BOE$。即$BE=DE$。

*在（1）的证明过程中也会用到$cosA=sinC=sin \angle ABD$即$\angle ABD=\angle C$，下方是补证。*
补证$\angle ABD=\angle C$：
